  ...
  return (
    <div>
      <div className={styles.menuIcon} onClick={toggleNavbar}>
        <a>
          <span
            className={`${styles.menuIconLine} ${isActive ? styles.menuIconActiveLine : ""
              }`}
          ></span>
          <span
            className={`${styles.menuIconLine} ${isActive ? styles.menuIconActiveLine : ""
        ...
        <span
          className={`${styles.menuIconLineLeft} ${isActive ? styles.menuIconActiveLineLeft : ""
            }`}
        ></span>
        <span
          className={`${styles.menuIconLineRight} ${isActive ? styles.menuIconActiveLineRight : ""
            }`}
        ></span>
      </div>
